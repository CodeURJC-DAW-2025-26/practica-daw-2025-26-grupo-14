...
/**
 * Minimal REST API for the main entities of the application.
 *
 * NOTE: This controller is intended to complement the existing server-side
 * rendered web UI. It exposes basic CRUD operations for Products, Users, Orders
 * and Ratings.
 */
@CrossOrigin(origins = "*")
@RestController
